; SMT-LIBv2 description generated by Yosys 0.7 (git sha1 UNKNOWN, clang 5.0.0 -march=x86-64 -mtune=generic -O2 -fstack-protector-strong -fPIC -Os)
...
; yosys-smt2-assert baud_generator#1 ../rtl/Tx/baud_generator.v:29
(define-fun |baud_generator#1| ((state |baud_generator_s|)) Bool (or false (not false))) ; $assert$../rtl/Tx/baud_generator.v:29$54
(define-fun |baud_generator_a| ((state |baud_generator_s|)) Bool 
  (|baud_generator#1| state)
)
...
(define-fun |PISO_shift_register_t| ((state |PISO_shift_register_s|) (next_state |PISO_shift_register_s|)) Bool (and
  (= (|PISO_shift_register#5| state) (|PISO_shift_register#3| next_state)) ; $procdff$142 \data_shift_reg
  (= (|PISO_shift_register#6| state) (|PISO_shift_register#2| next_state)) ; $procdff$141 \data_out
...
(define-fun |TxUART#5| ((state |TxUART_s|)) Bool (not (or  (= ((_ extract 0 0) (|TxUART#4| state)) #b1) (= ((_ extract 1 1) (|TxUART#4| state)) #b1) (= ((_ extract 2 2) (|TxUART#4| state)) #b1) (= ((_ extract 3 3) (|TxUART#4| state)) #b1)))) ; $eq$../rtl/Tx/TxUART.v:58$37_Y
(define-fun |TxUART#6| ((state |TxUART_s|)) Bool (not (or  (|TxUART#5| state) false))) ; $logic_not$../rtl/Tx/TxUART.v:58$38_Y
...
(define-fun |TxUART#9| ((state |TxUART_s|)) Bool (= (|TxUART#4| state) #b0001)) ; $eq$../rtl/Tx/TxUART.v:29$33_Y
(define-fun |TxUART#10| ((state |TxUART_s|)) (_ BitVec 1) (ite (|TxUART#9| state) #b0 (|TxUART#7| state))) ; $procmux$127_Y
(define-fun |TxUART#11| ((state |TxUART_s|)) (_ BitVec 1) (ite (|TxUART#2| state) #b1 (|TxUART#10| state))) ; $0\start_tx[0:0]
(define-fun |TxUART#12| ((state |TxUART_s|)) (_ BitVec 4) (bvadd (|TxUART#4| state) #b0001)) ; $add$../rtl/Tx/TxUART.v:47$36_Y
(define-fun |TxUART#13| ((state |TxUART_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|TxUART#7| state)) #b1) #b1 #b0)) ; $auto$wreduce.cc:347:run$150 [0]
(define-fun |TxUART#14| ((state |TxUART_s|)) Bool (= (|TxUART#4| state) #b1010)) ; $procmux$120_CMP
(define-fun |TxUART#15| ((state |TxUART_s|)) Bool (= (|TxUART#4| state) #b1001)) ; $procmux$121_CMP [7]
(define-fun |TxUART#16| ((state |TxUART_s|)) Bool (= (|TxUART#4| state) #b1000)) ; $procmux$121_CMP [6]
(define-fun |TxUART#17| ((state |TxUART_s|)) Bool (= (|TxUART#4| state) #b0111)) ; $procmux$121_CMP [5]
(define-fun |TxUART#18| ((state |TxUART_s|)) Bool (= (|TxUART#4| state) #b0110)) ; $procmux$121_CMP [4]
(define-fun |TxUART#19| ((state |TxUART_s|)) Bool (= (|TxUART#4| state) #b0101)) ; $procmux$121_CMP [3]
(define-fun |TxUART#20| ((state |TxUART_s|)) Bool (= (|TxUART#4| state) #b0100)) ; $procmux$121_CMP [2]
(define-fun |TxUART#21| ((state |TxUART_s|)) Bool (= (|TxUART#4| state) #b0011)) ; $procmux$121_CMP [1]
(define-fun |TxUART#22| ((state |TxUART_s|)) Bool (= (|TxUART#4| state) #b0010)) ; $procmux$121_CMP [0]
(define-fun |TxUART#23| ((state |TxUART_s|)) Bool (or  (|TxUART#15| state) (|TxUART#16| state) (|TxUART#17| state) (|TxUART#18| state) (|TxUART#19| state) (|TxUART#20| state) (|TxUART#21| state) (|TxUART#22| state))) ; $procmux$121_CTRL
(define-fun |TxUART#24| ((state |TxUART_s|)) (_ BitVec 4) (ite (|TxUART#5| state) (concat #b000 (|TxUART#13| state)) (ite (|TxUART#9| state) #b0010 (ite (|TxUART#23| state) (|TxUART#12| state) (ite (|TxUART#14| state) #b1011 #b0000))))) ; $procmux$119_Y
(define-fun |TxUART#25| ((state |TxUART_s|)) (_ BitVec 4) (ite (|TxUART#0| state) (|TxUART#24| state) (|TxUART#4| state))) ; $0\state[3:0]
...
(define-fun |TxUART_t| ((state |TxUART_s|) (next_state |TxUART_s|)) Bool (and
  (= (|TxUART#11| state) (|TxUART#7| next_state)) ; $procdff$144 \start_tx
  (= (|TxUART#25| state) (|TxUART#4| next_state)) ; $procdff$143 \state
